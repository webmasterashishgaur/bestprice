...
<html>
	...
	<body>
		<a href="#edit-negociacionEnc" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-negociacionEnc" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${negociacionEncInstance?.version}" />
				<fieldset class="form">
